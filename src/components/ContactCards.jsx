...
export default function ContactCards() {
  return (
    <div className="w-full space-y-6 min-w-0">
      <CardShell
        title="Direct"
        desc="Copy my email and reach out instantly."
      >
        <CopyField
          label="Email"
      ...
      <CardShell
        title="Perfect first message"
        desc="Fastest reply if you include:"
      >
      ...
      <CardShell
        title="Availability"
        desc="Open to freelance, contract, and collabs."
      >
